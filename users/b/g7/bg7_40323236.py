...
bg7_40323236 = Blueprint('bg7_40323236', __name__, url_prefix='/bg7_40323236', template_folder='templates')
...
@bg7_40323236.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg7_40323236.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg7_40323236.route('/circle36/<x>/<y>/<degree>')

def drawcircle36(x, y, degree):
    return head_str + chain_str + circle36(int(x), int(y), int(degree)) + tail_str
    
#@bg7_40323236.route('/circle36/<int:x>/<int:y>/<int:degree>')
...
@bg7_40323236.route('/circle35/<x>/<y>/<degree>/<a>/<b>/<degree2>')
...
@bg7_40323236.route('/a')
def draw_a():
    return head_str + chain_str + a(0, 0) + tail_str
@bg7_40323236.route('/task36_1')
def task36_1():
    outstring = '''
<!DOCTYPE html>
<html>
