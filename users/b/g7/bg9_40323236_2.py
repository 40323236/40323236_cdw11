...
bg9_40323236_2 = Blueprint('bg9_40323236_2', __name__, url_prefix='/bg9_40323236_2', template_folder='templates')
...
'''
    ...
    return outstring
@bg9_40323236_2.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg9_40323236_2.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323236_2.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg9_40323236_2.route('/circle1/<x>/<y>/<degree>')
#@bg9_40323236_2.route('/circle1/<int:x>/<int:y>/<int:degree>')
...
@bg9_40323236_2.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg9_40323236_2.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg9_40323236_2.route('/circle2/<x>/<y>/<degree>')
#@bg9_40323236_2.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg9_40323236_2.route('/twocircle/<x>/<y>')
@bg9_40323236_2.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg9_40323236_2.route('/eighteenthirty/<x>/<y>')
@bg9_40323236_2.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg9_40323236_2.route('/snap')
...
@bg9_40323236_2.route('/snap_link')
...
@bg9_40323236_2.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
